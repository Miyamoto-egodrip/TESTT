*изменил 2 задание : теперь принемает аргументы из командной строки

*изменил 3 задание : добавил библиотеку в \TESTT\TEST3\src\lib 

*изменил 4 задание : теперь код читает из data.txt в столбец
